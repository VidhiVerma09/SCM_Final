...
def hangman():
    ...
    Instructions:
    1. The computer will choose a word, and you have to guess it by suggesting letters.
    2. You can only make a limited number of incorrect guesses before the game ends.
    3. If you guess a letter that is in the word, it will be revealed in the correct positions.
    4. If you guess a letter that is not in the word, you will lose a life.
    5. The game ends when you guess the word correctly or run out of lives.
